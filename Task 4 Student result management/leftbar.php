<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="Sonali Betageri" class="img-circle profile-img">
                                <h6 class="title">Sonali Betageri</h6>
                                <small class="info">Intern</small>
                            </div>
                            <!-- /.user-info -->
